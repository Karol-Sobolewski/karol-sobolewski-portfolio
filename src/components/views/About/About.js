...
const Component = ({ className, children }) => {
  ...
  return (
    <div className={clsx(className, styles.root)}>
      ...
      <p>
        I'm 28 years old junior fullstack web developer from Kraków, Poland.
      </p>
      <p>
      ...
      <p>
        ...
        Kodilla. Since then almost every day I spend on learning new
        technologies. Right now I'm taking Wes Bos's courses.
      </p>
      <h3>Besides work</h3>
      <img src="/images/olmec.jpg" alt="Olmecs" />
      <p>
        I like history, especially Olmec archaeology. Olmec culture was earliest
        Mesoamerican civilization that was spread across Gulf of Mexico and
        other regions of Mexico, Guatemala and Honduras from 1700 till 400 BC.
      </p>
      <p>
        I spend my free time on watching films and TV series. I also like
        reading fantasy, crime fiction and historical books. Besides that I love
        to play video games including: Civilization 6, Heroes of Might & Magic
        III, Crusader Kings II, Ancestors Legacy, Hell Let Loose, Red Dead
